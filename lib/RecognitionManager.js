...
var RecognitionManager = /*#__PURE__*/function () {
  ...
  _createClass(RecognitionManager, [{
    ...
    value: function emitListeningChange(listening) {
      ...
      (0, _utils.sendSlack)("emitListeningChange(".concat(listening, ")"));
    ...
    value: function emitMicrophoneAvailabilityChange(isMicrophoneAvailable) {
      ...
      (0, _utils.sendSlack)("emitMicrophoneAvailabilityChange(".concat(isMicrophoneAvailable, ")"));
    ...
    value: function disconnect(disconnectType) {
      (0, _utils.sendSlack)("disconnect(".concat(disconnectType, ")"));
    ...
    value: function disableRecognition() {
      (0, _utils.sendSlack)('disableRecognition()');
    ...
    value: function onError(event) {
      (0, _utils.sendSlack)('onError()::' + event.error);
      ...
      if (event && event.error) {
        ...
        (_this$onErrorProps = this.onErrorProps) === null || _this$onErrorProps === void 0 ? void 0 : _this$onErrorProps.call(this, event);
      }
    }
  }, {
    key: "onRecognitionDisconnect",
    value: function onRecognitionDisconnect() {
      (0, _utils.sendSlack)('onRecognitionDisconnect()');
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                (0, _utils.sendSlack)('startListening()::1', !this.recognition);
              ...
              case 4:
                ...
                (0, _utils.sendSlack)("startListening()::2::".concat(isContinuousChanged, ", ").concat(isLanguageChanged, ", ").concat(this.listening));
              ...
              case 22:
                ...
                (0, _utils.sendSlack)('startlistening()::catch');
        ...
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                (0, _utils.sendSlack)('abortListening()');
        ...
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                (0, _utils.sendSlack)('stopListening()');
