...
var RecognitionManager = exports["default"] = /*#__PURE__*/function () {
  ...
  return _createClass(RecognitionManager, [{
    ...
    value: function emitListeningChange(listening) {
      var _this = this;
      (0, _utils.sendSlack)(this.slackToken, "emitListeningChange(".concat(listening, ")"));
    ...
    value: function emitMicrophoneAvailabilityChange(isMicrophoneAvailable) {
      var _this2 = this;
      (0, _utils.sendSlack)(this.slackToken, "emitMicrophoneAvailabilityChange(".concat(isMicrophoneAvailable, ")"));
    ...
    value: function disconnect(disconnectType) {
      (0, _utils.sendSlack)(this.slackToken, "disconnect(".concat(disconnectType, ")"));
    ...
    value: function disableRecognition() {
      (0, _utils.sendSlack)(this.slackToken, 'disableRecognition()');
      if (this.recognition) {
    ...
    value: function onError(event) {
      (0, _utils.sendSlack)(this.slackToken, 'onError()::' + event.error);
    ...
    value: function onRecognitionDisconnect() {
      (0, _utils.sendSlack)(this.slackToken, 'onRecognitionDisconnect()');
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              (0, _utils.sendSlack)(this.slackToken, 'startListening()::1', !this.recognition);
              if (this.recognition) {
                _context.next = 4;
                break;
              }
            ...
            case 4:
              ...
              (0, _utils.sendSlack)(this.slackToken, "startListening()::2:: continuous:".concat(isContinuousChanged, ", language:").concat(isLanguageChanged, ", listening:").concat(this.listening));
            ...
            case 22:
              ...
              (0, _utils.sendSlack)(this.slackToken, "startlistening()::catch::".concat(!(_context.t0 instanceof DOMException), "::$").concat(JSON.stringify(_context.t0)));
              if (!(_context.t0 instanceof DOMException)) {
                this.emitMicrophoneAvailabilityChange(false);
              }
              this.stopListening();
              onStartException === null || onStartException === void 0 || onStartException();
            case 28:
            case "end":
      ...
      var _abortListening = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              (0, _utils.sendSlack)(this.slackToken, 'abortListening()');
      ...
      var _stopListening = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              (0, _utils.sendSlack)(this.slackToken, 'stopListening()');
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              ...
              (0, _utils.sendSlack)(this.slackToken, 'start()');
              _context4.next = 4;
    ...
    value: function stop() {
      if (this.recognition && this.listening) {
        (0, _utils.sendSlack)(this.slackToken, 'stop()');
    ...
    value: function abort() {
      if (this.recognition && this.listening) {
        (0, _utils.sendSlack)(this.slackToken, 'abort()');
