...
var RecognitionManager = /*#__PURE__*/function () {
  ...
  _createClass(RecognitionManager, [{
    ...
    value: function onRecognitionDisconnect() {
      ...
      this.listening = false;
      console.log('onRecognitionDisconnect::listening::', this.listening);
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 3:
                ...
                (0, _utils.sendSlack)("isContinuousChanged: ".concat(isContinuousChanged, ", isLanguageChanged: ").concat(isLanguageChanged, ", listening: ").concat(this.listening));
                (0, _utils.sendSlack)("recognition: ".concat(this.recognition.continuous));
