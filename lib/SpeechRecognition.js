...
var SpeechRecognition = {
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _ref4 = _args.length > 0 && _args[0] !== undefined ? _args[0] : {}, continuous = _ref4.continuous, language = _ref4.language, onAudioEnd = _ref4.onAudioEnd, onAudioStart = _ref4.onAudioStart;
  ...
  stopListening: function () {
    var _stopListening = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(_ref5) {
      var onAudioEnd, onAudioStart, recognitionManager;
      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              onAudioEnd = _ref5.onAudioEnd, onAudioStart = _ref5.onAudioStart;
              recognitionManager = SpeechRecognition.getRecognitionManager({
                onAudioEnd: onAudioEnd,
                onAudioStart: onAudioStart
              });
