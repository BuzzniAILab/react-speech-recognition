...
exports.sendSlack = exports.browserSupportsPolyfills = exports.compareTwoStringsUsingDiceCoefficient = exports.commandToRegExp = exports.concatTranscripts = exports.debounce = void 0;
...
var sendSlack = function sendSlack(message) {
  console.log('SpeechRecognition::' + message);

  try {// fetch('https://hooks.slack.com/services/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', {
    //   method: 'POST',
